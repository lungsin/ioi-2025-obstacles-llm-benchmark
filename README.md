...
4. To prevent cheating (LLM can search for the solution or editorial online), disable the web search/fetch functionality of the LLM agents.
...
2. Run the test script:
    ```sh
    bash run_tests.sh <path-to-solution.cpp> 2048000 2 # Memory limit and time limit
    ```
